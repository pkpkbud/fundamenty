...
- [Mam kilka programów **ABC** na kluczu USB](https://github.com/pkpkbud/fundamenty/releases/download/7.0.0/Fundamenty-ABC6-7.0.0-win32.msi)
- [Mam tylko **ABC Płyta** na kluczu USB](https://github.com/pkpkbud/fundamenty/releases/download/7.0.0/Fundamenty-ABC6p-7.0.0-win32.msi)
- [Mam tylko **ABC Tarcza** na kluczu USB](https://github.com/pkpkbud/fundamenty/releases/download/7.0.0/Fundamenty-ABC6t-7.0.0-win32.msi)
- [Mam tylko **ABC Rama3D** na kluczu USB](https://github.com/pkpkbud/fundamenty/releases/download/7.0.0/Fundamenty-ABC6r-7.0.0-win32.msi)
- [Mam tylko **ABC Obiekt3D** na kluczu USB](https://github.com/pkpkbud/fundamenty/releases/download/7.0.0/Fundamenty-ABC6s-7.0.0-win32.msi)
